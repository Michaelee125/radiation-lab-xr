...
On desktop, hold the right mouse button and drag, or use the arrow keys, to look around the floating information arc. The left mouse button remains dedicated to controls and shield dragging.
...
- rolling-average duration, analogue-meter range and maximum audible click rate;
...
- `js/radiation-emitter.js` defines reusable alpha, beta and gamma A-Frame models, distinct trails, mystery-mode visual hiding and fixed-size object pools.
